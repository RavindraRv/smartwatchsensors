...
class _MyAppState extends State<MyApp> {
  ...
  void initPedometer() {
    _pedestrianStatusStream = Pedometer.pedestrianStatusStream.listen((PedestrianStatus event) {
      setState(() {
  ...
  Future<void> _generateCsvFile() async {
    ...
    final csvString = 'accelerometer_x,accelerometer_y,accelerometer_z,gyroscope_x,gyroscope_y,gyroscope_z,step_count,status\n' +
        csvData;
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: isWear ? AmbientMode(builder: (context, mode, child) => child!, child: home) : home,
    );
  }
